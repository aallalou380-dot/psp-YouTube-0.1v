...
static void drawHome(int selectedVideo)
{
    ...
    drawVideoCard(0, x1, y1, 211, 92, selectedVideo == 0);
    drawVideoCard(1, x2, y1, 211, 92, selectedVideo == 1);
    drawVideoCard(2, x1, y2, 211, 92, selectedVideo == 2);
    drawVideoCard(3, x2, y2, 211, 92, selectedVideo == 3);
}
...
static void drawTrending(int selectedVideo)
{
    ...
    drawVideoCard(4, 18, 60, 211, 92, selectedVideo == 4);
    drawVideoCard(5, 251, 60, 211, 92, selectedVideo == 5);
    drawVideoCard(1, 18, 174, 211, 92, selectedVideo == 1);
    drawVideoCard(2, 251, 174, 211, 92, selectedVideo == 2);
}
